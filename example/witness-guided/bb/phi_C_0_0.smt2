...
(assert (<= 1 mode_0))
(assert (<= mode_0 1))
(assert (and (and (>= v0_0_0 31.3067) (<= v0_0_0 100) (= t_0_0 0) (= Sy_0_0 0) (= Sx_0_0 0)) (= mode_0 1) (= [v0_0_t t_0_t Sy_0_t Sx_0_t] (integral 0. time_0 [v0_0_0 t_0_0 Sy_0_0 Sx_0_0] flow_1)) (= mode_0 1) (forall_t 1 [0 time_0] (< Sx_0_t 100)) (< Sx_0_t 100) (< Sx_0_0 100) (= mode_0 1) (> t_0_t 1e-06) (<= Sy_0_t 0)))
(check-sat)
(exit)
